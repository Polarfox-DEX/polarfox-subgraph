...
export function updatePolarfoxDayData(event: EthereumEvent): PolarfoxDayData {
  ...
  let polarfoxDayData = PolarfoxDayData.load(dayID.toString())
  if (polarfoxDayData === null) {
    polarfoxDayData = new PolarfoxDayData(dayID.toString())
    polarfoxDayData.date = dayStartTimestamp
    polarfoxDayData.dailyVolumeUSD = ZERO_BD
    polarfoxDayData.dailyVolumeAVAX = ZERO_BD
    polarfoxDayData.totalVolumeUSD = ZERO_BD
    polarfoxDayData.totalVolumeAVAX = ZERO_BD
    polarfoxDayData.dailyVolumeUntracked = ZERO_BD
  }

  polarfoxDayData.totalLiquidityUSD = polarfox.totalLiquidityUSD
  polarfoxDayData.totalLiquidityAVAX = polarfox.totalLiquidityAVAX
  polarfoxDayData.txCount = polarfox.txCount
  polarfoxDayData.save()

  return polarfoxDayData as PolarfoxDayData
}
